...
Добавь модель Transactions в scheme.prisma:
...
Обнови модель User и Category - добавь обратные связи с transactions Transactions[]
...
- GET /transactions: список с query параметрами dateFrom, dateTo, type, categroyId (по пользователю)
...
Используй @api/src/modules/categories как образец структуры для backend
