...
Каркас поднят и проверен: зависимости установлены, миграция применена, API
стартует и отвечает. Бизнес-логика — заготовки: методы сервисов бросают
`Not implemented`, страницы фронтенда содержат только разметку-заглушку.
