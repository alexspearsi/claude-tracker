...
- [ ] 03-01-PLAN.md — Сквозной срез: карточка «Сводка за месяц» (три показателя + разбивка по категориям) на `/dashboard` (SUM-01, SUM-02)
...
| 3. Сводка и баланс | 0/1 | Not started | - |
