...
- [x] **Phase 3: Сводка и баланс** - Баланс/доходы/расходы за месяц и разбивка по категориям на дашборде (completed 2026-09-21)
...
- [x] 03-01-PLAN.md — Сквозной срез: карточка «Сводка за месяц» (три показателя + разбивка по категориям) на `/dashboard` (SUM-01, SUM-02)
...
| 3. Сводка и баланс | 1/1 | Complete    | 2026-09-21 |
